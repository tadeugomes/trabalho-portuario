...
conforme nomenclatura da CNAE) **Transportes aquaviários**, conforme se
...
ggplot(aes(x = ano, y = n, group = n_divisao)) +
  ...
  bbc_style() +
   labs(title = "Vínculos do Setor Portuário e Aquaviário (2010 - 2020) ",
...
Nota-se ainda, ao analisar o gráfico acima, a queda do número de
vínculos em **Transporte Marítimo de Cabotagem e Longo Curso**, que foi
bastante acentuada, saindo de quase 9 mil vínculos em 2010 para menos de
4 mil em 2020.
...
Pelo gráfico a seguir, alguns sumários do setor podem ser obtidos por
grupo de atividade:
...
**raça ou cor** quando comparadas por **sexo**, optou-se pela **escala
logarítmica** no lugar da escala aritimética (escala habitual nos
gráficos) para representar os dados quantidade de vínculos (**eixo y**)
, pois a logarítmica permite, no caso do gráfico abaixo, uma
visualização das tendências das quantidades de vínculos por cada raça ou
cor ao longo dos anos analisados.
