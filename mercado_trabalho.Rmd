...
ggplot(aes(x = ano, y = n, group = secao)) +
  ...
  ggrepel::geom_text_repel(data = subset(g1, ano == 2020),
...
ggplot(aes(x = ano, y = n, group = n_divisao)) +
  ...
  geom_point(color = "black", size = 4) +
  ggrepel::geom_text_repel(aes(x = ano, y = n, label = scales::number(n, decimal.mark = ",", big.mark = ".")), nudge_x = -0.2, direction = "y", hjust = "right", size = 4, force = 1) +
...
ggplot(aes(x = ano, y = n, group = n_classe)) +
  ...
  geom_point(aes(color = n_classe), size = 4) +
  labs(x = "Ocupação", y = "Número de vínculos",
         caption = "Fonte: Observatório Portuário do Maranhão - Dados da RAIS 2020") +
  theme_classic() +
  theme(plot.title = element_text(size = 16L, face = "bold"),
