...
Verifica-se que a remuneração média dos trabalhadores portuários e aquaviários varia conforme o estado da federação. O Rio de Janeiro é o estado com a maior remuneração no período analisado, com o registro de R$ 5.668,50 em 2020. O Espírito Santo aparece em segundo lugar, com R$ 4.584,20.  

O estado do Maranhão teve uma evolução signifitiva no valor da remuneração média: saltou de R$ 1.257,90 em 2010 para R$ 2.803.50 em 2020.
